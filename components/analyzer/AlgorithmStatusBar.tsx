...
export const AlgorithmStatusBar = memo(function AlgorithmStatusBar({
  ...
  if (!isRunning) {
    return (
      <div className="flex items-center gap-1 px-1.5 py-0.5 text-dwa-sm tracking-wide text-muted-foreground">
  ...
  return (
    <TooltipProvider delayDuration={300}>
      <div className="flex items-center gap-1 px-1.5 py-0.5 text-dwa-sm tracking-wide font-mono">
            ...
            <div className="flex items-center gap-1">
              ...
              {showDetailed && (
                <div className="w-8 h-1.5 bg-muted rounded-full overflow-hidden">
                  <div
                    className={`h-full transition-[background-color,width] duration-300 ${msdReady ? 'bg-green-600 dark:bg-green-500' : 'bg-amber-600 dark:bg-amber-500'}`}
        ...
        {actualFps > 0 && (
          <>
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <span className={`tabular-nums text-dwa-sm tracking-tight ${
