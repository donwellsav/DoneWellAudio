...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    date: '2026-03-27',
    changes: [
      { type: 'fix', description: 'fix: resolve changelog merge conflict (keep clean v0.23.0 entry)' },
    ],
  },
  {
    version: '0.23.0',
    ...
    changes: [
      ...
      { type: 'feat', description: '**Cloud relay** with pairing code — no IP addresses, ports, or firewall config needed. Just share a code like DWA-A1B2' },
      ...
      { type: 'feat', description: '**Apply Latest EQ** action for manual Stream Deck control' },
      ...
      { type: 'feat', description: '**Companion help tab** with full setup guide, variable reference, OSC prefix guide, and troubleshooting' },
      ...
      { type: 'feat', description: 'Safety: max cut depth clamp (-12dB default), confidence gating, manual mode by default' },
    ],
  },
  {
    version: '0.21.1',
