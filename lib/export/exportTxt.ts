/**
 * TXT Report Generator for DoneWell Audio feedback history.
...
export function generateTxtReport(
  ...
  // Header
  w(LINE)
  w('                DONEWELL AUDIO - FEEDBACK ANALYSIS REPORT')
  w(LINE)
  blank()
  ...
  const version = typeof window !== 'undefined'
    ...
    : ''
  w(`Report generated by DoneWell Audio${version ? ` v${version}` : ''}`)
